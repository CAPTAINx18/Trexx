...
var trex, trex_run;
var edges, groun;
var ground_image, Invisible_ground, cloud, cloud_Image, random_number;
var obstacles, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6;
var random_obstacle, count;
var PLAY, END, gamestate;
var clouds_group, obstacles_group, reImage, gameover, trexdead, gameovertext, gameoverimage;
var score;
...
function setup(){
  ...
  gameover = createSprite(350, 120, 5, 5);
  gameover.addImage(reImage);
  gameover.scale = 0.6;
    
    
  gameovertext = createSprite(350, 80, 10, 10);
